...
import com.educat.android.educatapp.adapters.MeasurementAdapter;
...
import com.educat.android.educatapp.helperClasses.KeyValuePairsDialog;
...
public class MeasurementListActivity extends AppCompatActivity implements SimpleDialog.OnDialogResultListener, MeasurementAdapter.MeasurementAdapterCallback {
    ...
    private String EDIT_NAME_DIALOG = "dialogTagEditName";
    private String NAME = "name";
    private Measurement selectedMeasurement;
    private String IGNORE_SAVED_INSTANCE_STATE = "ignoreSavedInstanceState";
        ...
        if (EDIT_NAME_DIALOG.equals(dialogTag)){
            ...
            switch (which){
                case BUTTON_POSITIVE:
                    ...
                    pDialog.setMessage("Saving edit...");
                    showDialog();

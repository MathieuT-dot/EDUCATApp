package com.educat.android.educatapp.setups;
...
public class Instrument implements Parcelable {
    ...
    public static class IdComparator implements Comparator<Instrument> {
        @Override
    ...
    public static class NameComparator implements Comparator<Instrument> {
        @Override
        public int compare(Instrument o1, Instrument o2) {
    ...
    public static class InstrumentTypeIdComparator implements Comparator<Instrument> {
        @Override
        public int compare(Instrument o1, Instrument o2) {
            return Integer.compare(o1.instrumentTypeId, o2.instrumentTypeId);
        }
    }

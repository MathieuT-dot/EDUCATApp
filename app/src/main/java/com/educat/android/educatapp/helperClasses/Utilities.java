...
import com.educat.android.educatapp.setups.ParameterOption;
import com.educat.android.educatapp.setups.Setup;
import com.educat.android.educatapp.setups.Type;
 ...
 * Utilities
 *
 * Various utilities used to parse JSON, convert value, display toasts with adjustable text size
 */
...
//        MyLog.d(TAG, res.toString());
    ...
    public static boolean isOnline() {
        try {
            Process p1 = Runtime.getRuntime().exec("ping -c 1 www.educat2seas.eu");
...
//        intent.putExtra(KEY_RESTART_INTENT, nextIntent);
    ...
    private static ArrayList<String> createSetupValuesArrayList(Setup setup){
        ...
        arrayList.add("");
        arrayList.add("" + setup.getId());
        arrayList.add("" + setup.getName());
        arrayList.add("" + setup.getHardwareIdentifier());
        arrayList.add("" + setup.getVersion());
        arrayList.add("" + setup.isLocked());
        return arrayList;
    }
    ...
    private static ArrayList<String> createInstrumentValuesArrayList(Instrument instrument){
        ArrayList<String> arrayList = new ArrayList<>();
        arrayList.add("");
        arrayList.add("" + instrument.getId());
        arrayList.add("" + instrument.getName());
        arrayList.add("" + instrument.getDescription());
        arrayList.add("" + instrument.isLocked());
        arrayList.add("" + instrument.getInstrumentTypeId());
        arrayList.add("" + instrument.getSetupId());
        return arrayList;
    }
    ...
    private static ArrayList<String> createTypeValuesArrayList(Type type){
        ...
        arrayList.add("" + type.getCategory());
        arrayList.add("" + type.getDescription());
        return arrayList;
    }
    ...
    private static ArrayList<String> createParameterValuesArrayList(Parameter parameter, boolean showValueDescription){
        ...
        arrayList.add("" + parameter.getDescription());
        arrayList.add("" + parameter.getValue());
        if (showValueDescription){
            arrayList.add("" + parameter.getValueDescription());
        }
        arrayList.add("" + parameter.getLevel());
        arrayList.add("" + parameter.getDataType());
        arrayList.add("" + parameter.getMainBoard());
        arrayList.add("" + parameter.getMin());
        arrayList.add("" + parameter.getMax());
        arrayList.add("" + parameter.getDefaultValue());
        return arrayList;
    }
        ...
        for (int i = 0; i < setup.getInstrumentArrayList().size(); i++){
            ...
            for (int j = 0; j < instrument.getParameterArrayList().size(); j++){
                ...
                switch (parameter.getId()){
                    ...
                    case Constants.SETUP_PRM_DATA_OUTPUT_DATATYPE:
                        ...
                        if (parameter.getValue() != null) {
                            ...
                            switch (Float.floatToIntBits(parameter.getValue())){
                                ...
                                case (int) Constants.SETUP_PRM_DATA_OUTPUT_DATATYPE_option_CAN_DISTANCE_NODES_D7_0XD7__4IR_ONLY_CALCULATED_VALUE:
                                    outputDataType = (int) Constants.SETUP_PRM_DATA_OUTPUT_DATATYPE_option_CAN_DISTANCE_NODES_D7_0XD7__4IR_ONLY_CALCULATED_VALUE;
                                    variableArrayList.add(new Variable("Calculated", "cm", 1f, Variable.UNSIGNED_SHORT, 1, valueIndex++));
                                    indexOffset = 3;
                                    break;

                                case (int) Constants.SETUP_PRM_DATA_OUTPUT_DATATYPE_option_CAN_DISTANCE_NODES_D8_0XD8__US_3IR_ONLY_CALCULATED_VALUE:
                                    outputDataType = (int) Constants.SETUP_PRM_DATA_OUTPUT_DATATYPE_option_CAN_DISTANCE_NODES_D8_0XD8__US_3IR_ONLY_CALCULATED_VALUE;
                                    variableArrayList.add(new Variable("Calculated", "cm", 1f, Variable.UNSIGNED_SHORT, 1, valueIndex++));
                                    indexOffset = 3;
                                    break;
